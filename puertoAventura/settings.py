"""
Django settings for puertoAventura project.
...
SECRET_KEY = "django-insecure-2b74)zymlby1f2#9s58s*8@w)uz($_&y1oz73@@_+a@!$mjfd="
...
ROOT_URLCONF = "puertoAventura.urls"
...
WSGI_APPLICATION = "puertoAventura.wsgi.application"
